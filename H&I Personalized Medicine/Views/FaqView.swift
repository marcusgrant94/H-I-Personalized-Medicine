    ...
    var body: some View {
        ...
        VStack {
            ...
            Group {
                ...
                DisclosureGroup("Are the costs of laboratory testing, supplements, and prescriptions included in the cost of the package or hourly rates?") {
                    Text("No, laboratory tests, supplements, and medications are not included in the noted treatment costs. Your insurance company may cover some types of labs and medications. HIPM is happy to provide a Superbill to allow you to possibly be reimbursed for any costs paid out of pocket.")
                }
